...
const ListCustomerOrderPageComponent: React.FC<any> = (props: any) => {
  ...
  const [link, setLink] = useState(`${BACKENDAPI}/v1.0/orders/customers/${props.customerId}`);
...
export default withRouter(ListCustomerOrderPageComponent);
